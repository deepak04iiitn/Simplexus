...
import ClientPortal from './pages/agencies/ClientPortal'
...
function AppContent() {
  ...
  const isPrivateDashboard = location.pathname.startsWith('/invite/');
      ...
      <div className="flex flex-col min-h-screen">
        ...
        <div className="flex-grow">
          <Routes>
            ...
            <Route path='/campaigns/:id/brief' element={<BriefBuilder />} />
            <Route path='/campaigns/:id/assign-creators' element={<AssignCreators />} />
            ...
            <Route path='/creators/slug/:slug' element={<CreatorProfile />} />
